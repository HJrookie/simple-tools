<!-- src/views/Home.vue (New Version) -->
<template>
  <div class="home-container">
    ...
    <a-row :gutter="[24, 24]">
      <a-col :xs="24" :sm="12" :md="8" v-for="tool in tools" :key="tool.title">
...
<script>
import { Row, Col, TypographyTitle, TypographyParagraph } from "ant-design-vue";
